...
class GalacticSwarmOptimization(object):
    ...
    def __init__(self, fitness_function, dimension, range0, range1, m, n, l1, l2, ep_max, c1, c2, c3, c4):
...
if __name__ == '__main__':
    ...
    m_s = parameter_set["GSO1"]['m']
    n_s = parameter_set["GSO1"]['n']
    l1_s = parameter_set["GSO1"]['l1']
    l2_s = parameter_set["GSO1"]['l2']
    max_ep_s = parameter_set["GSO1"]['max_ep']
    c1_s = parameter_set["GSO1"]["c1"]
    c2_s = parameter_set["GSO1"]["c2"]
    c3_s = parameter_set["GSO1"]["c3"]
    c4_s = parameter_set["GSO1"]["c4"]
    ...
    def save_result(combination, all_gbests, gBest_fitness, total_time):
        ...
        path = '../results/' + str(fitness_function_name) + '/GSO1(PSO+PSO)/'
